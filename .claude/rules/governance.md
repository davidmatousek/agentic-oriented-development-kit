...
This file defines mandatory governance workflows for Agentic Oriented Development Kit. All agents must follow these sign-off requirements when creating specs, plans, and tasks.
