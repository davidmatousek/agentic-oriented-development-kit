...
Extract the IDEA-NNN identifier from user arguments. Validate the format matches `IDEA-` followed by a 3-digit number. If invalid or missing, display usage: `Usage: /aod.score IDEA-NNN`
